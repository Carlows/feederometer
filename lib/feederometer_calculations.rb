...
class FeederometerCalculations
	...
	def calculate_feeder_data_for_single_summoner(summoner_name)
	...
	def calculate_feeder_percentage(stats_data)
		games_player_feed = stats_data.inject(0) do | total, data_item |
			...
			puts "deaths #{deaths}, assists #{assists}, kills #{kills}"
...
pp feederometer.calculate_feeder_data_for_single_summoner("stefforsomething") 
